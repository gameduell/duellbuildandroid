...
class EnvironmentSetup
{
    ...
    private function downloadPackages(regex : EReg)
    {
        ...
        var packageListOutput = new DuellProcess(androidSDKPath + "/tools/", androidExec, ["list", "sdk", "--all"], {block:true, errorMessage: "trying to list the packages to download"}).getCompleteStdout().toString(); 
